...
const cases = [
  ...
  {
    title: 'Продажа спецтехники в РФ',
    industry: 'Промышленность',
    description: 'Ведём работу над сайтом: наполняем информацией о компании и оборудовании. Запущена баннерная реклама в Яндекс Директ.',
    results: [
      { label: 'Сайт в работе', value: '✓' },
      { label: 'Баннерная реклама', value: '✓' },
      { label: 'Узнаваемость бренда', value: '↑' }
  ...
  {
    title: 'Туры по горному Алтаю и Байкалу',
    industry: 'Туризм',
    description: 'Разработка Квиза, аудит отдела продаж и запуск рекламы в Яндекс Директ.',
    results: [
      { label: 'Квиз', value: '✓' },
      { label: 'Аудит продаж', value: '✓' },
      { label: 'Яндекс Директ', value: '✓' }
    ],
    image: 'Mountain'
  }
